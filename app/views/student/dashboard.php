            ...
            <div class="card-body">
                ...
                <?php else: ?>
                    <div class="text-center py-4">
                        <img src="public/images/login_hero.svg" alt="Learn" class="img-fluid mb-3" style="max-height: 100px; object-fit: contain;" onerror="this.onerror=null; this.src='public/images/logo.png';">
