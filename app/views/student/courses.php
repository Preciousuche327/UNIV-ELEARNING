    ...
    <div class="row g-4" id="coursesGrid">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 animate__animated animate__fadeInUp course-card-container">
                    <div class="card h-100 border-0 shadow-sm course-card overflow-hidden">
                        <div class="position-relative">
                            <img src="https://images.unsplash.com/photo-1497633762265-9d179a990aa6?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" class="card-img-top" alt="Course" style="height: 160px; object-fit: cover;" onerror="this.onerror=null; this.src='public/images/books.png';">
                        </div>
        ...
        <?php else: ?>
            <div class="col-12 text-center py-5">
                <img src="public/images/login_hero.svg" alt="No courses" style="height: 180px; object-fit: contain;" class="mb-4" onerror="this.onerror=null; this.src='public/images/logo.png';">
