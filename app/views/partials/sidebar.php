...
<div class="bg-dark text-white border-end" id="sidebar-wrapper" style="min-width: 250px; min-height: 100vh;">
    ...
    <div class="list-group list-group-flush p-3">
        ...
        <?php if ($user_type === 'Admin'): ?>
            <a href="?page=manage-users" class="list-group-item list-group-item-action bg-dark text-white border-0 py-3 rounded mb-1">
                <i class="bi bi-people me-2"></i> Manage Users
            </a>
            <a href="?page=manage-courses" class="list-group-item list-group-item-action bg-dark text-white border-0 py-3 rounded mb-1">
                <i class="bi bi-book me-2"></i> Manage Courses
            </a>
        <?php elseif ($user_type === 'Instructor'): ?>
            <a href="?page=my-courses" class="list-group-item list-group-item-action bg-dark text-white border-0 py-3 rounded mb-1">
                <i class="bi bi-journal-text me-2"></i> My Courses
            </a>
            <a href="?page=student-results" class="list-group-item list-group-item-action bg-dark text-white border-0 py-3 rounded mb-1">
        ...
        <?php elseif ($user_type === 'Student'): ?>
            ...
            <a href="?page=my-enrollments" class="list-group-item list-group-item-action bg-dark text-white border-0 py-3 rounded mb-1">
                <i class="bi bi-mortarboard me-2"></i> My Learning
            </a>
            <a href="?page=my-results" class="list-group-item list-group-item-action bg-dark text-white border-0 py-3 rounded mb-1">
