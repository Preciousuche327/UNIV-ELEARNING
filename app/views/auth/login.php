        ...
        <div class="row w-100 m-0">
            ...
            <div class="col-lg-6 d-none d-lg-flex auth-bg align-items-center justify-content-center flex-column text-white p-5 animate__animated animate__fadeIn">
                <div style="z-index: 1;" class="text-center">
                    <img src="https://illustrations.popsy.co/white/surreal-hourglass.svg" alt="E-Learning" class="img-fluid mb-5" style="max-height: 350px; drop-shadow: 0 10px 20px rgba(0,0,0,0.2);" onerror="this.onerror=null; this.src='public/images/books.png';">
