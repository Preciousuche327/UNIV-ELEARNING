                    ...
                    <form method="POST">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="content_url" class="form-control form-control-lg shadow-none border-2" value="<?php echo htmlspecialchars($content['ContentURL']); ?>" placeholder="https://youtube.com/..." required>
                            </div>
                        </div>
